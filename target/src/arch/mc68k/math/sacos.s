/* sacos.s - Motorola 68040 FP arc-cosine routines (EXC) */
...
|--ACOS(X) = PI/2 FOR DENORMALIZED X
	fmovel		d1,fpcr		/* load user's round mode/precision */
	fmovex		PIBY2,fp0
	jra 		__x_t_frcinx
...
|--ACOS(X) = 2 * ATAN(	SQRT( (1-X)/(1+X) )	)
	...
	clrl		d1
	bsrl		__x_satan		|...ATAN(SQRT([1-X]/[1+X]))
...
ACOSBIG:
	...
	fbgtl		__x_t_operr		| cause an operr exception
