...
/* strxfrm works as a finite state machine executing the state table stored
 * at __wcstate defined below.
 */

#define X (ST_FOLD | ST_OUTPUT | ST_INPUT)

static const ushort_t __table[257] = 
    {
    0,
...
__statetable __wcstate = 
    {
    &__table[1]
    };

__statetable __mbstate = 
    {
    &__table[1]
    };
