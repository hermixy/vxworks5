...
--------------------
01d,01jun99,drm  Adding code to check for and extract the shared memory
                 interface.
01c,19may99,drm  Changing vxfusion to vxfusion
...
This file is included by usrExtra.c which is in turn included by usrConfig.c.
