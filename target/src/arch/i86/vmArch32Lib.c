...
vmArch32Lib.c provides the virtual memory mapping and virtual address
translation that works with the unbundled VM library VxVMI.
It provides 2 routines that are linked in when INCLUDE_MMU_FULL and 
...
*
* This routine maps 32bit physical pages into a contiguous block of 32bit 
